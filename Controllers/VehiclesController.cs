...
namespace UNITINS_DoisIrmaos.Controllers
{
    public class VehiclesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Available,Active,CategoryID")] Vehicle vehicle)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Available,Active,CategoryID")] Vehicle vehicle)
        {
            if (id != vehicle.Id)
            {
                return NotFound();
