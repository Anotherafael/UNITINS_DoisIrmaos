...
namespace UNITINS_DoisIrmaos.Controllers
{
    public class TaxesController : Controller
    {
        ...
        public TaxesController(Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,PricePerDay")] Tax tax)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,PricePerDay")] Tax tax)
        {
            if (id != tax.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Context.Taxes'  is null.");
            }
            var tax = await _context.Taxes.FindAsync(id);
            if (tax != null)
            {
